...
#Matriz que contiene los vectores promedio en cada fila
...
del data_train, data_test, corpus_mat_train, corpus_mat_test, corpus_mat_inv, corpus
del df_vect_train, df_vect_test, df_q_vect, df_q_vect_inv, df_vect_inv_train
